...
export default function AdminDashboardPage() {
  ...
  useEffect(() => {
    document.title = `Admin Dashboard | ${websiteName}`
  }, [websiteName])
          ...
          >
            ...
            <div className="p-8 rounded-xl border border-border bg-card hover:bg-card/80 transition-colors">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h3 className="text-lg font-semibold text-foreground">Roadmap Management</h3>
              </div>
              <p className="text-sm text-muted-foreground mb-6">
                Create and manage interactive developer roadmaps.
              </p>
              <Button asChild variant="ghost" className="text-primary hover:text-primary/80">
                <Link to="/admin/roadmaps">Manage Roadmaps →</Link>
              </Button>
            </div>
